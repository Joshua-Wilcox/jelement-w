...
public final nonisolated class CompoundUIColors {
    ...
    private nonisolated static let coreTokens = CompoundCoreUIColorTokens.self
    ...
    /// Colours that can be read away from the main actor, unlike the isolated `UIColor.compound`.
    ///
    /// Runtime values set with ``CompoundUIColors/override(_:with:)`` are not applied here.
    public nonisolated enum Nonisolated {
        public static let textPrimary = CompoundUIColorTokens().textPrimary
        ...
        public static let _bgCodeBlock = CompoundCoreUIColorTokens.gray100
    }
